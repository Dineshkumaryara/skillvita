    ...
    <div>
      ...
      <div className="px-6 md:px-20 py-12 text-gray-800 dark:text-gray-200 text-justify">
        <div className="max-w-4xl mx-auto">
          ...
          <br />
          <br />
          This Privacy Policy describes how (CourseVita) BHUVANA INFORMATION
          TECHNOLOGIES PRIVATE LIMITED (the &quot;Site&quot;, &quot;we&quot;,
          &quot;us&quot;, or &quot;our&quot;) collects, uses, and discloses your
          personal information when you visit, use our services, or make a
          purchase from https://www.coursevita.com/ (the &quot;Site&quot;) or
          ...
          Services. Changes to This Privacy Policy <br />
          <br />
          ...
          depending on how you interact with us. <br />
          ...
          <ul className="list-disc ml-6 space-y-1">
            <li>
              Basic contact details including name, address, phone number, email
            </li>
            <li>
              Order info including billing/shipping address, payment details
            </li>
            <li>Account info like username, password, security questions</li>
            <li>Shopping behavior like viewed or wishlist items</li>
            <li>
              {" "}
          ...
          <p>
            ...
            interaction with the Services <br />
            ...
            information on our behalf, such as: <br />
            <br />
            <ul className="list-disc ml-6 space-y-1">
              <li>
          ...
          <ul className="list-disc ml-6 space-y-1">
            <li>
              ...
              to send notifications to you related to your account, purchases,
            ...
            <li>
              ...
              or postal mail, and to show you advertisements for products or
            ...
            <li>
              ...
              illegal or malicious activity. If you choose to use the Services
              and register an account, you are responsible for keeping your
          ...
          <p>
            ...
            Policy. Such circumstances may include: <br />
          </p>
          <br />
          <ul className="list-disc ml-6 space-y-1">
            <li>
            ...
            <li>
              ...
              provide services and advertise to you. [For example, we use
              Shopify to support personalized advertising with third-party
              services]. Our business and marketing partners will use your
          ...
          <p>
            ...
            *) about users for the purposes set out above in &quot;How we
            Collect and Use your Personal Information&quot; and &quot;How we
          ...
          <br />
          <p className="font-medium mt-4">Categories of Recipients:</p>
          <ul className="list-disc ml-6 space-y-1">
            <li>
          ...
          purposes of inferring characteristics about you. We have
          &quot;sold&quot; and &quot;shared&quot; (as those terms are defined in
          applicable law) personal information over the preceding 12 months for
          ...
          <br />
          - Business and marketing partners br User Generated Content
          <br /> <br />
          ...
          <p>
            ...
            set out below to request that it be deleted <br /> s of the
            ...
            disputes or enforce other applicable contracts and policies <br />{" "}
            <br />
          </p>
          <h2 className="text-xl font-semibold mt-10">
          ...
          <h2 className="text-xl font-semibold mt-10">Complaints</h2>
          <p>
            {" "}
            ...
            determined to provide an adequate level of protection. <br />
          </p>
          ...
          <p>
            ...
            available to you, please call or email us at Reachus@coursevita.com
            or contact us at 3rd floor Spaces and more, Business park, Lumbini
            Avenue, Gachibowli, Hyderabad, Hyderabad, TS, 500032, India.{" "}
          </p>
        </div>
      </div>
    </div>
